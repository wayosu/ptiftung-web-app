        ...
        <div class="relative max-w-[85rem] w-full mx-auto">
            <div class="absolute bottom-0 start-0 px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
                <h2 class="text-light-100 text-2xl lg:text-3xl font-display font-bold">
                    ...
                    <br>
                    <span class="font-body font-normal uppercase">Prasarana</span>
                </h2>
            </div>
        </div>
    </header>
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <template x-for="result in results" :key="result.id">
                            <a :href="'{{ route('fasilitas.prasarana.detail', '') }}' + '/' + result.slug"
        ...
        function liveSearch() {
            return {
                ...
                fetchResults(page = 1) {
                    ...
                    this.isLoading = true;
                    fetch(`/api/v1/prasarana/search?query=${this.query}&page=${page}`, {
                        method: 'GET',
                        headers: {
