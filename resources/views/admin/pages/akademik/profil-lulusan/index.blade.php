            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('profilLulusan.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myDataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('profilLulusan.index') }}",
                columns: [{
                        data: 'judul'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function(gambar) {
                            let path =
                                `{{ asset('storage/akademik/profil-lulusan/`+ gambar +`') }}`;
                            return `
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('profilLulusan.destroy', ':id') }}";
