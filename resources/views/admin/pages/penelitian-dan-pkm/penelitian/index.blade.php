            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('penelitian.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myDataTables').DataTable({
                ...
                buttons: [
                    ...
                    { 
                        extend: 'csv', 
                        title: 'Penelitian',
                        filename: 'penelitian-' + new Date().toISOString().slice(0, 10),
                        className: 'btn btn-sm btn-dark border',
                        exportOptions: {
                            columns: dataArrayForDataTables
                        }
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('penelitian.destroy', ':id') }}";
