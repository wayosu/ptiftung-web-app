            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('pengabdianMasyarakat.create') }}">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @role('Superadmin|Admin|Kajur')
                const dataArrayForDataTables = [0, 1, 2, 3, 4, 5, 6];
            @endrole
            @role('Kaprodi|Dosen')
            ...
            $('#myDataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('pengabdianMasyarakat.index') }}",
                columns: [
                    { data: 'tahun' },
                ...
                buttons: [
                    ...
                    { 
                        ...
                        filename: 'pengabdian-masyarakat-' + new Date().toISOString().slice(0, 10),
                        className: 'btn btn-sm btn-dark border',
                        exportOptions: {
                            columns: dataArrayForDataTables
                        }
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('pengabdianMasyarakat.destroy', ':id') }}";
