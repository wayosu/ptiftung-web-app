...
@section('content')
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('pengabdianMasyarakat.index') }}">
    ...
    <div class="container-xl px-4 mt-4">
        <form
            action="@if (isset($pengabdianMasyarakat)) {{ route('pengabdianMasyarakat.update', $pengabdianMasyarakat->id) }} @else {{ route('pengabdianMasyarakat.store') }} @endif"
            ...
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    @if (isset($pengabdianMasyarakat) && $pengabdianMasyarakat->createdBy)
                        <div class="card-header bg-white">
                            <div
                                ...
                                <div class="text-xs text-muted">
                                    ...
                                    <span>
                                        {{ $pengabdianMasyarakat->createdBy->name }}
                                    </span>
                                </div>
                                <div class="text-xs text-muted">
                                    <i class="fa-solid fa-calendar fa-xs me-1"></i>
                                    <span>
                                        {{ \Carbon\Carbon::parse($pengabdianMasyarakat->created_at)->isoFormat('dddd, D MMMM Y H:mm') }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('tahun') is-invalid @enderror" name="tahun" id="tahunField"
                                type="number" placeholder="{{ $pengabdianMasyarakat->tahun ?? 'Masukkan tahun' }}"
                                autocomplete="off" />
                            @if (isset($pengabdianMasyarakat))
                                <input type="hidden" name="tahun_lama" value="{{ $pengabdianMasyarakat->tahun ?? '' }}">
                            @endif
                            @error('tahun')
                                ...
                                <select name="dosen_id" id="dosenField"
                                    ...
                                    @foreach ($namaDosen as $item)
                                        <option value="{{ $item['id'] }}"
                                            {{ old('dosen_id', $pengabdianMasyarakat->dosen_id ?? '') == $item['id'] ? 'selected' : '' }}>
                                            {{ $item['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('dosen_id')
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('jabatan') is-invalid @enderror" name="jabatan"
                                ...
                                value="{{ old('jabatan', $pengabdianMasyarakat->jabatan ?? '') }}" autocomplete="off" />
                            @error('jabatan')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('skim') is-invalid @enderror" name="skim" id="skimField"
                                ...
                                value="{{ old('skim', $pengabdianMasyarakat->skim ?? '') }}" autocomplete="off" />
                            @error('skim')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('judul') is-invalid @enderror" name="judul" id="judulField"
                                ...
                                value="{{ old('judul', $pengabdianMasyarakat->judul ?? '') }}" autocomplete="off" />
                            @error('judul')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('sumber_dana') is-invalid @enderror" name="sumber_dana"
                                ...
                                value="{{ old('sumber_dana', $pengabdianMasyarakat->sumber_dana ?? '') }}"
                                autocomplete="off" />
                            @error('sumber_dana')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('jumlah_dana') is-invalid @enderror" name="jumlah_dana"
                                ...
                                value="{{ old('jumlah_dana', $pengabdianMasyarakat->jumlah_dana ?? '') }}"
                                autocomplete="off" />
                            @error('jumlah_dana')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                    ...
                    @if (isset($pengabdianMasyarakat) && $pengabdianMasyarakat->updatedBy)
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <span class="fw-bolder">
                                        {{ $pengabdianMasyarakat->updatedBy->name }}
                                    </span>
                                    pada
                                    <span class="fw-bolder">
                                        {{ \Carbon\Carbon::parse($pengabdianMasyarakat->updated_at)->isoFormat('dddd, D MMMM Y') }}
                                    </span>
                                    pukul
                                    <span class="fw-bolder">
                                        {{ \Carbon\Carbon::parse($pengabdianMasyarakat->updated_at)->isoFormat('H:mm') }}
                                    </span>
                                </div>
                            </div>
                        </div>
