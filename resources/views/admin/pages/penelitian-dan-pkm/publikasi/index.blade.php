            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('publikasi.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myDataTables').DataTable({
                ...
                columns: [
                    ...
                    { data: 'judul' },
                    {
                        ...
                        render: function(data) {
                            if (data) {
                                return '<a href="' + data +
                                    '" target="_blank" class="btn btn-sm btn-primary"><i class="fa-solid fa-arrow-up-right-from-square me-1"></i> Lihat Publikasi</a>';
                            } else {
                                return '-';
                            }
                        }
                ...
                buttons: [
                    ...
                    { 
                        extend: 'csv', 
                        title: 'Publikasi',
                        filename: 'publikasi-' + new Date().toISOString().slice(0, 10),
                        className: 'btn btn-sm btn-dark border',
                        exportOptions: {
                            columns: dataArrayForDataTables,
                            format: {
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('publikasi.destroy', ':id') }}";
