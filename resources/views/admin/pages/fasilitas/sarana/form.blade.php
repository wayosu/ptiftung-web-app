                        ...
                        @role('Superadmin|Admin|Kajur')
                            <div class="mb-3">
                                ...
                                <select name="program_studi" id="prodiField"
                                    ...
                                    <option value="SISTEM INFORMASI" @if (isset($sarana) && $sarana->program_studi == 'SISTEM INFORMASI') selected @endif>
                                        SISTEM INFORMASI
                                    </option>
                                    <option value="PEND. TEKNOLOGI INFORMASI" @if (isset($sarana) && $sarana->program_studi == 'PEND. TEKNOLOGI INFORMASI') selected @endif>
