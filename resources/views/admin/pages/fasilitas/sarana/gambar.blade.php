        ...
        <div class="card">
            <div class="card-body p-2 overflow-hidden">
                <div class="row g-2 row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    @foreach ($saranaImages as $image)
                        <div class="col">
                            <a href="{{ asset('storage/fasilitas/sarana/' . $image) }}" data-lightbox="image"
                                data-title="{{ $image ?? '' }}" class="gallery-image-container">
                                <img src="{{ asset('storage/fasilitas/sarana/' . $image) }}"
                                    alt="sarana-image-{{ $image ?? '' }}" class="gallery-image rounded" />
                            </a>
                        </div>
                    @endforeach
                </div>
