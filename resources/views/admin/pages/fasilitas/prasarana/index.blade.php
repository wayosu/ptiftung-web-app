            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('prasarana.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myDataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('prasarana.index') }}",
                columns: [{
                        data: 'keterangan'
                    },
                    {
                        data: 'prasarana_kategori.prasarana_kategori'
                    },
                    {
                        data: 'created_at',
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('prasarana.destroy', ':id') }}";
