...
@section('content')
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('mapi.index') }}">
    ...
    <div class="container-xl px-4 mt-4">
        <form
            action="@if (isset($mapi)) {{ route('mapi.update', $mapi->id) }} @else {{ route('mapi.store') }} @endif"
                ...
                <div class="col-xl-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-0 overflow-hidden text-center">
                            <img src="{{ asset('storage/mahasiswa-dan-alumni/peluang-mahasiswa/magang-atau-praktik-industri/' . $mapi->gambar) }}"
            ...
            <div class="{{ isset($mapi) ? 'col-xl-8' : 'col-xl-6' }}">
                <div class="card mb-4">
                    <div class="card-header">Form {{ $title ?? '' }}</div>
                    @if (isset($mapi) && $mapi->createdBy)
                        <div class="card-header bg-white">
                            <div
                                ...
                                <div class="text-xs text-muted">
                                    ...
                                    <span>
                                        {{ \Carbon\Carbon::parse($mapi->created_at)->isoFormat('dddd, D MMMM Y H:mm') }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="summernote" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror">{{ old('deskripsi', $mapi->deskripsi ?? '') }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="card-footer p-2 bg-white">
                            <div
                                ...
                                <div>
                                    ...
                                    pada
                                    <span class="fw-bolder">
                                        {{ \Carbon\Carbon::parse($mapi->updated_at)->isoFormat('dddd, D MMMM Y') }}
                                    </span>
                                    pukul
                                    <span class="fw-bolder">
                                        {{ \Carbon\Carbon::parse($mapi->updated_at)->isoFormat('H:mm') }}
                                    </span>
                                </div>
                            </div>
                        </div>
