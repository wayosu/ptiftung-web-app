            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('beasiswa.create') }}">
    ...
    <script>
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(gambar) {
                            let path =
                                `{{ asset('storage/mahasiswa-dan-alumni/peluang-mahasiswa/beasiswa/`+ gambar +`') }}`;
                            return `
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('beasiswa.destroy', ':id') }}";
