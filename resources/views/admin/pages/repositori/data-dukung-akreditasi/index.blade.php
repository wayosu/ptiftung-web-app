                ...
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        @role('Superadmin|Admin|Kajur|Kaprodi')
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('dataDukungAkreditasi.create') }}">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @endrole
            @role('Kaprodi|Dosen')
                const dataArrayForDataTables = [0, 1, 2, 3];
            @endif
            $('#myDataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('dataDukungAkreditasi.index') }}",
                columns: [
                    @role('Superadmin|Admin|Kajur')
                    { data: 'program_studi' },
                    @endrole
                    ...
                    { data: 'keterangan', },
                    {
                        ...
                        render: function(data, type, row) {
                            if (row.dokumen) {
                                return '<a href="/storage/repositori/data-dukung-akreditasi/' + row
                                    .dokumen +
                ...
                buttons: [
                    ...
                    { 
                        extend: 'csv',
                        title: 'Data Dukung Akreditasi',
                        filename: 'data-dukung-akreditasi-' + new Date().toISOString().slice(0, 10),
                        className: 'btn btn-sm btn-dark border',
                        exportOptions: {
                            columns: dataArrayForDataTables,
                            format: {
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('dataDukungAkreditasi.destroy', ':id') }}";
