            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('berita.create') }}">
    ...
    <script>
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(thumbnail) {
                            let path =
                                `{{ asset('storage/konten/berita/`+ thumbnail +`') }}`;
                            return `
                    ...
                    },
                    {
                        ...
                        render: function(status) {
                            if (status == 'published') {
                                ...
                                return `
                                    <span class="badge bg-green-soft text-green">Draft</span>
                                `;
                            }
                        }
                    },
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('berita.destroy', ':id') }}";
