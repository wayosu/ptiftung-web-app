            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        ...
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('kegiatanMahasiswa.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#myDataTables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('kegiatanMahasiswa.index') }}",
                    type: 'GET',
                    data: function(d) {
            ...
            $('body').on('click', '.tombol-hapus', function(e) {
                ...
                const deleteUrl = "{{ route('kegiatanMahasiswa.destroy', ':id') }}";
